...
$(".tryagain").click(function() {
        ...
        $( "#matches").delay(1000).fadeOut(0);
        $( ".score").delay(1000).fadeOut(0);
        $( ".tryagain").delay(1000).fadeOut(0);
        $( "#endheart").delay(1000).fadeOut(0);
        $("#answers").show();
        $("#container").delay(1000).fadeIn();
        $("#like").delay(1000).fadeIn(0);
        $("#dislikebutton").delay(1000).fadeIn();
